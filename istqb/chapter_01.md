...
25) Which of the following statements describes a key principle of software testing?
    ...
    1. For a software system, it is normally impossible to test all the input and output combinations
    1. Exhaustive software testing is, with enough effort and tool support, feasible for all software
    1. The purpose of software testing is demonstrating the absence of defects in software products
    <details><summary>Answer:</summary>2</details></br>

26) Which of these are objectives for software testing?
    1. Determine the productivity of programmers
    1. Eliminate the need for future program maintenance
    1. Eliminate every error prior to release
    1. Uncover software errors
    <details><summary>Answer:</summary>4</details></br>

27) Failure is _________
    1. Inprogram behavior due to a fault in the program
    1. Bug found before product Release
    1. Bug found after product Release
    1. Bug found during Design phase
    <details><summary>Answer:</summary>1</details></br>
...
28) During the software development process, at what point can the test process start?
    ...
    1. When the software requirements have been approved
...
29) How much testing is enough?
    ...
    1. The answer depends on the risk for your industry, contract and special requirements
    1. This answer depends on the maturity of your developers
    <details><summary>Answer:</summary>3</details></br>
...
31) One Key reason why developers have difficulty testing their own work is:
    ...
    1. Lack of test tools on the market for developers
    1. Lack of training
...
32) Which of the following could be a reason for a failure
    ...
    - 2 (B) Software fault
    - 3 (C) Design fault
    - 4 (D) Environment Fault
    - 5 (E) Documentation Fault

    1. B is a valid reason; A,C,D & E are not
    1. A,B,C,D are valid reasons; E is not
    1. A,B,C are valid reasons; D & E are not
    1. All of them are valid reasons for failure
    <details><summary>Answer:</summary>3</details></br>

33) Test are prioritized so that:
    1. You shorten the time required for testing
    1. You do the best testing in the time available
    1. You do more effective testing
    1. You find more faults
    <details><summary>Answer:</summary>2</details></br>
...
34) During which test activity could faults be found most cost effectively?
    ...
    1. Design
    1. Planning
    1. Check Exit criteria completion
    <details><summary>Answer:</summary>3</details></br>
...
37) The purpose of requirement phase is
    ...
    1. To define the scope of testing
    1. All of the above
    <details><summary>Answer:</summary>4</details></br>
...
38) A reliable system will be one that:
    ...
    1. Is likely to be liked by the users
    <details><summary>Answer:</summary>2</details></br>

39) Testing should be stopped when:
    1. All the planned tests have been run
    1. Time has run out
    1. All faults have been fixed correctly
    1. Both A. and C.
    1. I depends on the risks for the system being tested
    <details><summary>Answer:</summary>5</details></br>

40) The cost of fixing a fault:
    1. Is not important
    1. Increases as we move the product towards live use
    1. Decreases as we move the product towards live use
